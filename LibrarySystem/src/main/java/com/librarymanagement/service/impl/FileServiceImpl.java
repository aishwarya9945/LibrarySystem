...
import com.librarymanagement.constant.Item;
import com.librarymanagement.mapper.Mapper;
...
public class FileServiceImpl implements FileService {
	...
	public void exportCSV(String fileName, HttpServletResponse response)
		...
		case PUBLISHER:
			...
			break;
		case BORROWER:
			StatefulBeanToCsv<BorrowerRecord> writer5 = getWriter(response.getWriter());
			writer5.write(Mapper.borrowerModelToVo(borrowerService.findAllBorrowers()));
			break;
